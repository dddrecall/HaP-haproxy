...
enum {
	...
	HTTP_REQ_ACT_CUSTOM_CONT,
  	...
  	HTTP_REQ_ACT_SET2_HDR,
  	HTTP_REQ_ACT_DEL2_HDR,
  	HTTP_REQ_ACT_ADD_AFTER,
  	HTTP_REQ_ACT_ADD_BEFORE,
  	HTTP_REQ_ACT_ADD_REPLACE,
  	HTTP_REQ_ACT_ADD_XHC,
  	HTTP_REQ_ACT_ADD_VAFTER,
  	HTTP_REQ_ACT_ADD_VBEFORE,
  	HTTP_REQ_ACT_ADD_LAFTER,
  	HTTP_REQ_ACT_ADD_LBEFORE,
  	HTTP_REQ_ACT_ADD_UAFTER,
  	HTTP_REQ_ACT_ADD_UBEFORE,
  	HTTP_REQ_ACT_RM_FHTTP,
  	HTTP_REQ_ACT_RM_SE,
  	HTTP_REQ_ACT_RM_SE2,
  	HTTP_REQ_ACT_REP_HVALUE,
  	HTTP_REQ_ACT_ATOB,
  	HTTP_REQ_ACT_SET_REQ_FLINE,
